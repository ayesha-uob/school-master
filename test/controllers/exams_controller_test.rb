...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { edate: @exam.edate, ename: @exam.ename, enroll_id: @exam.enroll_id, subject: @exam.subject, teacher_id: @exam.teacher_id }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { edate: @exam.edate, ename: @exam.ename, enroll_id: @exam.enroll_id, subject: @exam.subject, teacher_id: @exam.teacher_id }
    assert_redirected_to exam_path(assigns(:exam))
  end
